...
export async function updateStudent(id: string, body: Record<string, string | null | undefined>) { return authenticatedFetch(`/students/${id}`, { method: "PATCH", headers: { "Content-Type": "application/json" }, body: JSON.stringify(body) }); }
...
export async function createStudent(body: Record<string, string | undefined>) { return authenticatedFetch("/students", { method: "POST", headers: { "Content-Type": "application/json" }, body: JSON.stringify(body) }); }
